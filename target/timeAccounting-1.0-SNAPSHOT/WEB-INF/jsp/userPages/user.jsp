...
<div class="container">
    <div class="table-wrapper">
        <div class="table-title">
            <div class="row">
                <div class="col-sm-8"><h2>Current activities</h2></div>
            </div>
        </div>
        <br><br><br>
        <table class="table table-bordered">
            ...
            <c:forEach var="activity" items="${activities}">
                <tr>
                    ...
                    <td>
                        <a class="delete" href="Controller?command=userSetTimeCommand&id=${activity.id}" title="Edit" data-toggle="tooltip"><i class="material-icons"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
    ...
    <nav>
        <ul class="pagination">
            <c:forEach begin="1" end="${countOfPages}" var="i">
                <li class="page-item"><a class="page-link" href="Controller?command=userCurrentActivitiesCommand&page=${i}">${i}</a></li>
            </c:forEach>
        </ul>
    </nav>
</div>
